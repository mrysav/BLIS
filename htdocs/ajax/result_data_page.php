...
<?php 
        if(isset($_REQUEST['l']))
        { 
            $next_link = __DIR__ . "/../ajax/result_data_page.php?a=".$_REQUEST['a']."&t=".$_REQUEST['t']."&l=".$_REQUEST['l']."&result_cap=".$result_cap."&result_counter=".($result_counter+1); 
        }
        else
        {
        ...
        if(isset($_REQUEST['l']))
        { 
            $prev_link = __DIR__ . "/../ajax/result_data_page.php?a=".$_REQUEST['a']."&t=".$_REQUEST['t']."&l=".$_REQUEST['l']."&result_cap=".$result_cap."&result_counter=".($result_counter - 1); 
        }
        else
        {
